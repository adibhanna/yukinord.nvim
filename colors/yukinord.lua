...
hl("NormalNC", { fg = colors.fg2, bg = colors.bg0 })
...
hl("StatusLineTermNC", { fg = colors.fg2, bg = colors.bg0 })
...
-- Mini.nvim statusline (single color scheme, slightly darker background)
hl("MiniStatuslineModeNormal", { fg = colors.fg2, bg = colors.bg1 })
hl("MiniStatuslineModeInsert", { fg = colors.fg2, bg = colors.bg1 })
hl("MiniStatuslineModeVisual", { fg = colors.fg2, bg = colors.bg1 })
hl("MiniStatuslineModeReplace", { fg = colors.fg2, bg = colors.bg1 })
hl("MiniStatuslineModeCommand", { fg = colors.fg2, bg = colors.bg1 })
hl("MiniStatuslineFilename", { fg = colors.fg2, bg = colors.bg1 })
hl("MiniStatuslineFileinfo", { fg = colors.fg2, bg = colors.bg1 })
hl("MiniStatuslineInactive", { fg = colors.fg2, bg = colors.bg1 })
...
-- Picker (Telescope-like interface) - file tree uses darker background
